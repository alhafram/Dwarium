export const Elements = {
    ...
    foodButtonBadgeSpan(): HTMLSpanElement {
        return document.getElementById('foodButtonBadgeSpan') as HTMLSpanElement
    },
    notesButton(): HTMLButtonElement {
        return document.getElementById('notesButton') as HTMLButtonElement
    },
    notesButtonBadgeSpan(): HTMLSpanElement {
        return document.getElementById('notesButtonBadgeSpan') as HTMLSpanElement
    },
    dressingSetsButton(): HTMLButtonElement {
        return document.getElementById('dressingSetsButton') as HTMLButtonElement
    },
    dressingSetsButtonBadgeSpan(): HTMLSpanElement {
        return document.getElementById('dressingSetsButtonBadgeSpan') as HTMLSpanElement
    },
    beltSetsButton(): HTMLButtonElement {
        return document.getElementById('beltSetsButton') as HTMLButtonElement
    },
    beltSetsButtonButtonBadgeSpan(): HTMLSpanElement {
        return document.getElementById('beltSetsButtonButtonBadgeSpan') as HTMLSpanElement
    },
    chatLogButton(): HTMLButtonElement {
        return document.getElementById('chatLogButton') as HTMLButtonElement
    },
    chatLogButtonBadgeSpan(): HTMLSpanElement {
        return document.getElementById('chatLogButtonBadgeSpan') as HTMLSpanElement
    },
    chatSettingsButton(): HTMLButtonElement {
        return document.getElementById('chatSettingsButton') as HTMLButtonElement
    },
    chatSettingsButtonBadgeSpan(): HTMLSpanElement {
        return document.getElementById('chatSettingsButtonBadgeSpan') as HTMLSpanElement
    },
    notificationsButton(): HTMLButtonElement {
        return document.getElementById('notificationsButton') as HTMLButtonElement
    },
    notificationsButtonBadgeSpan(): HTMLSpanElement {
        return document.getElementById('notificationsButtonBadgeSpan') as HTMLSpanElement
    },
    effectSetsButton(): HTMLButtonElement {
        return document.getElementById('effectSetsButton') as HTMLButtonElement
    },
    effectSetsButtonBadgeSpan(): HTMLSpanElement {
        return document.getElementById('effectSetsButtonBadgeSpan') as HTMLSpanElement
    },
    ...
    expiringItemsSettingsButtonBadgeSpan(): HTMLSpanElement {
        return document.getElementById('expiringItemsSettingsButtonBadgeSpan') as HTMLSpanElement
    },
    gameSettingsButton(): HTMLButtonElement {
        return document.getElementById('gameSettingsButton') as HTMLButtonElement
    },
    gameSettingsButtonBadgeSpan(): HTMLSpanElement {
        return document.getElementById('gameSettingsButtonBadgeSpan') as HTMLSpanElement
    },
    ...
    statsButtonBadgeSpan(): HTMLSpanElement {
