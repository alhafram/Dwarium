...
function renderFavouriteLinks() {
    ...
    favouriteLinks.forEach(link => {
        ...
        const right = process.platform == 'win32' ? '20px' : '12px'
        let favouriteLinkElement = `<div class=" h-9 w-full hover:bg-inputBackgroundColor dark:hover:bg-inputBackgroundColorDark">
                ...
                <button style="right: ${right}; margin-top: 5px;" class="relative float-right w-5.5 h-5.5 hover:bg-disabledButton dark:hover:bg-addTabDarkHover rounded-full">
