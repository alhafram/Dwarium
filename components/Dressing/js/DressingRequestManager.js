...
async function changeStyle(zikkuratId, styleId) {
    let req = `fetch("http://${window.myAPI.server()}.dwar.ru/action_run.php", {
      "headers": {
        "content-type": "application/x-www-form-urlencoded",
        "upgrade-insecure-requests": "1"
      },
      "referrer": "http://${window.myAPI.server()}.dwar.ru/action_form.php?${Math.random()}&artifact_id=${zikkuratId}&in[param_success][url_close]=user.php%3Fmode%3Dpersonage%26group%3D2%26update_swf%3D1",
      "referrerPolicy": "no-referrer-when-downgrade",
